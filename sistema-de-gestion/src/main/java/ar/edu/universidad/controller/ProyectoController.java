package ar.edu.universidad.controller;
...
public class ProyectoController {
    ...
    @GetMapping("/activos")
    public List<Proyecto> obtenerProyectosActivos(@RequestParam(required = false) LocalDate fecha) {
        if (fecha == null)
            fecha = LocalDate.now();
        return proyectoService.buscarProyectosActivos(fecha);
    }

    @GetMapping("/nombre/{nombre}")
    public List<Proyecto> obtenerPorNombre(@PathVariable String nombre) {
